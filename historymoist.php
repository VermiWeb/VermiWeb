    ...
    <section id="content">
      <div id="History" class="tabcontent">
        ...
        <table>
          <tr>
            <th>DATE AND TIME</th>
            <th>SOIL MOISTURE VALUE 1</th>
            <th>SOIL MOISTURE VALUE 2</th>
            <th>SOIL MOISTURE VALUE 3</th>
            <th>SOIL MOISTURE VALUE 4</th>
          </tr>

          <?php
          while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
            $fieldname6 = $row['moist_time_date'];
            $fieldname2 = $row['moist_sensor1'];
            $fieldname3 = $row['moist_sensor2'];
            $fieldname4 = $row['moist_sensor3'];
            $fieldname5 = $row['moist_sensor4'];
            echo '<tr>
              <td>' . $fieldname6 . '</td>
              <td>' . $fieldname2 . '%</td>
              <td>' . $fieldname3 . '%</td>
