  ...
  <section id="content">
    <div id="History" class="tabcontent">
      ...
      <a class="nav-link dropdown-style" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <i class="fa-solid fa-solid fa-bell bell-style"></i>
      </a>
      ...
      <div class="profile-row">
        <img class="profile-img" src="images/profilepic.jpg" alt="profilepic.jpg">
        <div class="row info-row">
          <table>
            <tr>
              <td>
                <h3>
                  <scan class="profile-name">Hazel Tiffany Taylo</scan>
                </h3>
              </td>
            </tr>
            <tr>
              <td>
                <p class="profile-work">DLSU-D Student</p>
              </td>
            </tr>
            <tr>
              <td>
                <p class="profile-location">Cavite, Philippines</p>
              </td>
            </tr>
            <tr>
              <td>
      ...
      <div class="row">
        ...
        <p class="initialweight-values">100kg</p>
      </div>
      <div class="row">
        <h5 class="final-weight">EXPECTED FINAL WEIGHT: </h5>
        <p class="finalweight-values">50kg</p>
      </div>
      <div class="row">
      ...
      <button type="button" class="btn btn-success edit-button">Edit Profile</button>
    </div>
    </div>
